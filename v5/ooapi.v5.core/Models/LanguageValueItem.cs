...
namespace ooapi.v5.Models
{
    ...
    public partial class LanguageValueItem : IEquatable<LanguageValueItem>
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LanguageValueItem {\n");
        ...
        /// <summary>
        /// Returns true if LanguageValueItem instances are equal
        /// </summary>
        /// <param name="other">Instance of LanguageValueItem to be compared</param>
        /// <returns>Boolean</returns>
