...
namespace ooapi.v5.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProgramOffering : IEquatable<ProgramOffering>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>The first day on which a student can enroll for this program.</value>
        ...
        /// </summary>
        /// <value>The last day on which a student can enroll for this program.</value>
        ...
        /// </summary>
        /// <value>The academicsession during which this programoffering takes place. [&#x60;expandable&#x60;](#tag/academic_session_model) By default only the &#x60;academicSessionId&#x60; (a string) is returned. If the client requested an expansion of &#x60;academicSession&#x60; the full academicsession object should be returned. </value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProgramOffering)obj);
        }

        /// <summary>
        /// Returns true if ProgramOffering instances are equal
        /// </summary>
        /// <param name="other">Instance of ProgramOffering to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramOffering other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(ProgramOffering left, ProgramOffering right)
        {
