...
public interface ICoursesService
{
    ...
    Task<Pagination<Course>> GetAll(DataRequestParameters dataRequestParameters);
    Task<Pagination<Course>> GetCoursesByEducationSpecificationId(DataRequestParameters dataRequestParameters, Guid educationSpecificationId);
