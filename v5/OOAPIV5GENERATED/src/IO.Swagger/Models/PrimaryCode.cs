...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrimaryCode : IEquatable<PrimaryCode>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((PrimaryCode)obj);
        }

        /// <summary>
        /// Returns true if ComponentPrimaryCode instances are equal
        /// </summary>
        /// <param name="other">Instance of ComponentPrimaryCode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PrimaryCode other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(PrimaryCode left, PrimaryCode right)
        {
