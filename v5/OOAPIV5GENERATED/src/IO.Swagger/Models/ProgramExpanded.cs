...
namespace IO.Swagger.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProgramExpanded : IEquatable<ProgramExpanded>
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj.GetType() == GetType() && Equals((ProgramExpanded)obj);
        }

        /// <summary>
        /// Returns true if ProgramExpanded instances are equal
        /// </summary>
        /// <param name="other">Instance of ProgramExpanded to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProgramExpanded other)
        {
...
#pragma warning disable 1591
        ...
        public static bool operator ==(ProgramExpanded left, ProgramExpanded right)
        {
