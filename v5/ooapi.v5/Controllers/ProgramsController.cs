...
public class ProgramsController : BaseController
{
    ...
    public virtual async Task<IActionResult> ProgramsGetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _programsService.GetAllAsync(parameters, cancellationToken);
        return Ok(result);
    }
    ...
    public virtual async Task<IActionResult> ProgramsProgramIdCoursesGetAsync(
        [FromRoute][Required] Guid programId,
        [FromQuery] FilterParams filterParams,
        [FromQuery] PagingParams pagingParams,
        [FromQuery] string? teachingLanguage,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _coursesService.GetCoursesByProgramIdAsync(parameters, programId, cancellationToken);
        return Ok(result);
    }
    ...
    public virtual async Task<IActionResult> ProgramsProgramIdGetAsync(
        [FromRoute][Required] Guid programId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _programsService.GetAsync(programId, parameters, cancellationToken);
        if (result == null)
        {
            return NotFound();
        }
    ...
    public virtual async Task<IActionResult> ProgramsProgramIdOfferingsGetAsync(
        [FromRoute][Required] Guid programId,
        [FromQuery] FilterParams filterParams,
        [FromQuery] PagingParams pagingParams,
        [FromQuery] string? teachingLanguage,
    ...
    [SwaggerResponse(statusCode: 200, type: typeof(Programs), description: "OK")]
    public virtual async Task<IActionResult> ProgramsProgramIdProgramsGetAsync(
        [FromRoute][Required] Guid programId,
        [FromQuery] FilterParams filterParams,
        [FromQuery] PagingParams pagingParams,
        [FromQuery] string? teachingLanguage,
    ...
    {
        var parameters = new DataRequestParameters(filterParams, pagingParams, sort);
        var result = await _programsService.GetProgramsByProgramIdAsync(parameters, programId, cancellationToken);
        return Ok(result);
    }
}