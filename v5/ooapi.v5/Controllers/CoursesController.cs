...
public class CoursesController : BaseController
{
    ...
    public virtual async Task<IActionResult> CoursesCourseIdComponentsGetAsync(
        [FromRoute][Required] Guid courseId,
        [FromQuery] FilterParams filterParams,
        [FromQuery] PagingParams pagingParams,
        [FromQuery] string? teachingLanguage,
        [FromQuery] string? componentType,
        [FromQuery] string? sort = "componentId",
        CancellationToken cancellationToken = default)
    {
        var parameters = new DataRequestParameters(filterParams, pagingParams, sort);
        var result = await _componentsService.GetComponentsByCourseIdAsync(parameters, courseId, cancellationToken);
        return Ok(result);
    }
    ...
    public virtual async Task<IActionResult> CoursesCourseIdGetAsync(
        [FromRoute][Required] Guid courseId,
        [FromQuery] List<string> expand,
        [FromQuery] bool? returnTimelineOverrides,
        CancellationToken cancellationToken = default)
    {
        var result = await _coursesService.GetAsync(courseId, cancellationToken);
        if (result == null)
        {
            return NotFound();
        }
    ...
    public virtual async Task<IActionResult> CoursesCourseIdOfferingsGetAsync(
        [FromRoute][Required] Guid courseId,
        [FromQuery] FilterParams filterParams,
        [FromQuery] PagingParams pagingParams,
        [FromQuery] string? teachingLanguage,
    ...
    public virtual async Task<IActionResult> CoursesGetAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var result = await _coursesService.GetAllAsync(parameters, cancellationToken);
        return Ok(result);
    }
}