...
/// <summary>
///     Learning component offering information.
/// </summary>
public class LearningComponentOffering
{
    /// <summary>
    ///     Unique id for this learning component offering.
    /// </summary>
    [JsonPropertyName("learningComponentOfferingId")]
    public string LearningComponentOfferingIdValue { get; set; } = string.Empty;

    /// <summary>
    ///     The primary human readable identifier for this learning component offering.
    /// </summary>
    [JsonPropertyName("primaryCode")]
    public IdentifierEntry PrimaryCode { get; set; } = new();

    /// <summary>
    ///     The name of this learning component offering.
    /// </summary>
    ...
    /// <summary>
    ///     The identifier of the learning component that is offered in this learning component offering.
    /// </summary>
    [JsonPropertyName("learningComponentId")]
    public Identifier? LearningComponentId { get; set; }

    /// <summary>
    ///     The expanded learning component object that is offered in this learning component offering.
    /// </summary>
    [JsonPropertyName("learningComponent")]
    public LearningComponent? LearningComponent { get; set; }
    ...
    /// <summary>
    ///     The identifier of the academic session for which this learning component offering is intended.
    ...
    /// <summary>
    ///     The expanded academic session object for which this learning component offering is intended.
    ...
    /// <summary>
    ///     The identifiers of the course offerings this learning component offering is part of.
    ...
    /// <summary>
    ///     The expanded course offering objects this learning component offering is part of.
    ///     When the client requests expansion of `courseOfferings`, the full expanded course offering objects
    ...
    /// <summary>
    ///     The identifiers of the rooms for this learning component offering.
    ...
    /// <summary>
    ///     The expanded room objects for this learning component offering.
