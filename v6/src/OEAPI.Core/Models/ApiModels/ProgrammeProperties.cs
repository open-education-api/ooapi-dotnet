...
/// <summary>
///     A full snapshot of a programme's own properties, embedded inside a
///     <see cref="TimelineOverrideProgramme" /> entry - every field <see cref="Programme" /> itself
///     currently exposes, except its own id and <c>validFrom</c>/<c>validTo</c> (the enclosing
///     <see cref="TimelineOverrideProgramme" /> supplies the override's own validity window instead).
/// </summary>
