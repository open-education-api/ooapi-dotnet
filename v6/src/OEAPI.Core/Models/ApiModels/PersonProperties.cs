...
/// <summary>
///     The request body for <c>POST /persons</c>. Narrower than <see cref="Person" /> - the spec's
///     <c>PersonProperties</c> schema is the same set of attributes minus <c>personId</c>, since the
///     server generates that identifier on creation rather than accepting a client-supplied one.
/// </summary>
public class PersonProperties : IValidatableObject
{
    /// <summary>
