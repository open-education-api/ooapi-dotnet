...
/// <summary>
///     A full snapshot of a course's own properties, embedded inside a
///     <see cref="TimelineOverrideCourse" /> entry - every field <see cref="Course" /> itself
///     currently exposes, except its own id and <c>validFrom</c>/<c>validTo</c> (the enclosing
///     <see cref="TimelineOverrideCourse" /> supplies the override's own validity window instead).
/// </summary>
