...
/// <summary>
///     A single historical or future alternate snapshot of a course, returned inside
///     <see cref="Course.TimelineOverrides" /> when the client requests
...
public class TimelineOverrideCourse
{
    ...
    /// <summary>
    ///     The alternate snapshot of the course's own properties for this validity window.
    /// </summary>
    [JsonPropertyName("course")]
    public CourseProperties Course { get; set; } = new();
}
