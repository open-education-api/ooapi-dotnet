...
public static class LearningComponentOfferingMappingExtensions
{
    public static LearningComponentOffering ToApiModel(this LearningComponentOfferingEntity entity, string? consumer)
    {
        return new LearningComponentOffering
        {
            LearningComponentOfferingIdValue = entity.LearningComponentOfferingIdValue,
            ...
            LearningComponentId = entity.LearningComponent != null
                ? new Identifier { Value = entity.LearningComponent.ComponentId }
                : null,
    ...
    /// <summary>
    ///     Maps a <see cref="LearningComponentOffering" /> API model to a new
    ///     <see cref="LearningComponentOfferingEntity" />, for the create half of an upsert. Relationship
    ///     FK resolution requires an async DB lookup this synchronous method can't perform - the caller
    ///     resolves and sets those FKs itself after calling this method.
    /// </summary>
    public static LearningComponentOfferingEntity ToEntity(this LearningComponentOffering model)
    {
        return new LearningComponentOfferingEntity
        {
            LearningComponentOfferingIdValue = Guid.NewGuid().ToString(),
    ...
    /// <summary>
    ///     Updates an existing <see cref="LearningComponentOfferingEntity" /> from a
    ///     <see cref="LearningComponentOffering" /> API model, for the update half of an upsert. See
    ///     <see cref="ToEntity" /> regarding relationship FK resolution.
    /// </summary>
    public static void UpdateFrom(this LearningComponentOfferingEntity entity, LearningComponentOffering model)
    {
