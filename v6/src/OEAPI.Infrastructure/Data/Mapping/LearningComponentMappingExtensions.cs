...
public static class LearningComponentMappingExtensions
{
    public static LearningComponent ToApiModel(this LearningComponentEntity entity, string? consumer)
    {
        return new LearningComponent
        {
            ...
            ChildIds = entity.Children.Count > 0
                ? [.. entity.Children.Select(c => new Identifier { Value = c.ComponentId })]
                : null,
            Children = null,
    ...
    /// <summary>
    ///     Maps a <see cref="LearningComponent" /> API model to a new <see cref="LearningComponentEntity" />,
    ///     for the create half of an upsert. Course/Organisation/Parent/LearningOutcome FK resolution
    ...
    /// </summary>
    public static LearningComponentEntity ToEntity(this LearningComponent model)
    {
        return new LearningComponentEntity
        {
    ...
    /// <summary>
    ///     Updates an existing <see cref="LearningComponentEntity" /> from a <see cref="LearningComponent" />
    ///     API model, for the update half of an upsert. See <see cref="ToEntity" /> regarding FK resolution.
    /// </summary>
    public static void UpdateFrom(this LearningComponentEntity entity, LearningComponent model)
    {
