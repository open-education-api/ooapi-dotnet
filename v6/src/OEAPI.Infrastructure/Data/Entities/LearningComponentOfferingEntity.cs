...
/// <summary>
///     EF Core entity for LearningComponentOffering.
/// </summary>
[Table("LearningComponentOfferings")]
[Index(nameof(LearningComponentOfferingIdValue), IsUnique = true)]
public class LearningComponentOfferingEntity : BaseEntity, IHasOtherCodes
{
    /// <summary>
    ///     Gets or sets the learning component offering unique identifier value.
    /// </summary>
    [Required]
    [StringLength(36)]
    ...
    // Foreign keys
    /// <summary>
    ///     Gets or sets the learning component foreign key.
    /// </summary>
    public Guid? LearningComponentEntityId { get; set; }
    ...
    /// <summary>
    ///     Gets or sets the learning component.
    /// </summary>
    [ForeignKey(nameof(LearningComponentEntityId))]
    public virtual LearningComponentEntity? LearningComponent { get; set; }
    ...
    /// <summary>
    ///     Gets or sets the collection of learning component offering associations.
    /// </summary>
    public virtual ICollection<LearningComponentOfferingAssociationEntity> Associations { get; set; } =
        [];

    /// <summary>
    ///     Gets or sets the groups associated with this learning component offering.
    /// </summary>
