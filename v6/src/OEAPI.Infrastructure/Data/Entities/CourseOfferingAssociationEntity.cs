...
/// <summary>
///     EF Core entity for CourseOfferingAssociation.
/// </summary>
[Table("CourseOfferingAssociations")]
[Index(nameof(CourseOfferingAssociationIdValue), IsUnique = true)]
public class CourseOfferingAssociationEntity : BaseEntity, IHasOtherCodes
{
    /// <summary>
    ///     Gets or sets the course offering association unique identifier value.
    /// </summary>
    [Required]
    [StringLength(36)]
    public string CourseOfferingAssociationIdValue { get; set; } = string.Empty;
    ...
    // Foreign keys
    /// <summary>
    ///     Gets or sets the course offering foreign key.
    /// </summary>
    public Guid? CourseOfferingEntityId { get; set; }
    ...
    /// <summary>
    ///     Gets or sets the course offering.
    /// </summary>
    [ForeignKey(nameof(CourseOfferingEntityId))]
    public virtual CourseOfferingEntity? CourseOffering { get; set; }
