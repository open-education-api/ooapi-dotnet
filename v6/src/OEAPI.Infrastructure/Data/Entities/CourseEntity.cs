...
/// <summary>
///     EF Core entity for Course.
/// </summary>
[Table("Courses")]
[Index(nameof(CourseId), IsUnique = true)]
public class CourseEntity : BaseEntity, IHasOtherCodes
{
    /// <summary>
    ///     Gets or sets the course unique identifier (UUID from API).
    /// </summary>
    [Required]
    [StringLength(36)]
    ...
    /// <summary>
    ///     Gets or sets the collection of learning components for this course.
    /// </summary>
    public virtual ICollection<LearningComponentEntity> LearningComponents { get; set; } =
        [];

    /// <summary>
    ///     Gets or sets the collection of learning outcomes for this course.
    /// </summary>
    public virtual ICollection<LearningOutcomeEntity> LearningOutcomes { get; set; } =
        [];

    /// <summary>
    ///     Gets or sets the collection of course offerings for this course.
    /// </summary>
    public virtual ICollection<CourseOfferingEntity> CourseOfferings { get; set; } = [];

    /// <summary>
    ///     Gets or sets the collection of programmes this course belongs to.
    /// </summary>
    public virtual ICollection<ProgrammeEntity> ProgrammeEntities { get; set; } = [];

    /// <summary>
    ///     Gets or sets the persons who coordinate this course.
    /// </summary>
    public virtual ICollection<PersonEntity> CourseCoordinatorEntities { get; set; } = [];

    /// <summary>
    ///     Gets or sets the persons who instruct this course.
    /// </summary>
    public virtual ICollection<PersonEntity> CourseInstructorEntities { get; set; } = [];
    ...
    /// <summary>
    ///     Gets or sets the historical/future versions of this course (the spec's
    ///     <c>timelineOverrides</c> mechanism).
    /// </summary>
    public virtual ICollection<TimelineOverrideCourseEntity> TimelineOverrides { get; set; } = [];
}
